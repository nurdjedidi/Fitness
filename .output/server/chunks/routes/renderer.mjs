...
const appHead = {"meta":[{"charset":"UTF-8"},{"name":"viewport","content":"width=device-width, initial-scale=1.0, viewport-fit=cover"},{"name":"author","content":"Nûr"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/NutriWeb.ico"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"},"title":"NutriWeb"};
