import { createVNode, Transition, mergeProps, computed, provide, onScopeDispose, toRef, shallowRef, ref, withDirectives, vShow, Fragment, resolveDirective, reactive, watch, inject, withCtx, createTextVNode, withModifiers, useSSRContext, watchEffect, nextTick, toRaw, readonly, Teleport } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent } from 'vue/server-renderer';
import { m as makeComponentProps, e as makeDensityProps, c as useRender, R as Ripple, a as makeTagProps, f as makeGroupProps, g as useGroup, h as useResizeObserver, i as makeVariantProps, j as makeBorderProps, k as makeElevationProps, l as makeGroupItemProps, n as makeRoundedProps, o as makeRouterProps, p as makeSizeProps, q as useBorder, r as useVariant, s as useDensity, t as useElevation, v as useRounded, w as useSize, x as useGroupItem, y as useLink, z as genOverlays, A as VExpandXTransition, B as VIcon, C as VDefaultsProvider, b as makeDimensionProps, D as makeTransitionProps, E as useBackgroundColor, u as useDimension, F as useRouter, V as VContainer, G as VBtn, H as useTextColor, I as VFadeTransition, M as MaybeTransition, J as parseAnchor, K as flipSide, L as flipAlign, N as flipCorner, O as getAxis } from './VContainer-lYWTOxzK.mjs';
import { m as makeVInputProps, d as VAvatar, f as forwardRefs, e as makeVTextFieldProps, u as useForm, V as VCard, a as VCardTitle, b as VTextField, g as animate, h as getTargetBox, n as nullifyTransforms, i as VLabel, j as VInput, k as deceleratedEasing, s as standardEasing, l as acceleratedEasing, B as Box, o as getOverflow } from './VTextField-Byxaxvnz.mjs';
import { m as makeItemsProps, u as useItems, V as VDivider, a as VList, b as VListItem } from './VList-KiTS5MPt.mjs';
import { V as VForm } from './VForm-B5jdzF_i.mjs';
import { g as genericComponent, p as propsFactory, I as IconValue, E as deepEqual, m as makeThemeProps, t as useProxiedModel, f as getUid, q as provideDefaults, Y as omit, a0 as makeDisplayProps, o as useRtl, a1 as useDisplay, a2 as useGoTo, l as provideTheme, N as EventProp, O as useLocale, h as getCurrentInstance, v as useToggleScope, a5 as isClickInsideElement, F as wrapInArray, S as filterInputAttrs, a3 as focusableChildren, x as templateRef, j as convertToUnit, Z as focusChild, a7 as debounce, s as clamp, L as isObject, a8 as ensureValidVNode, $ as matchesSelector, y as destructComputed, a6 as getNextElement, a9 as checkPrintable, U as consoleError, a4 as defer } from './server.mjs';
