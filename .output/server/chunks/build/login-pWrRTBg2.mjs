...
import { n as VContainer, o as VIcon, l as VBtn } from './VContainer-C70GP2ji.mjs';
import { V as VCard, a as VCardTitle, b as VForm, c as VTextField } from './VTextField-D2z5XqY0.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
...
import 'vue-router';
import './VImg-DDLHiBKG.mjs';
import './VInput-m40Nv11T.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const signIn = async () => {
      ...
      (undefined).location.href = "/softai";
      if (!response.ok) {
...
//# sourceMappingURL=login-pWrRTBg2.mjs.map
