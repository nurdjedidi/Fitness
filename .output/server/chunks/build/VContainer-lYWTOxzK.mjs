import { capitalize, camelize, h, ref, readonly, toRefs, computed, createVNode, isRef, toRef, shallowRef, watch, nextTick, withDirectives, mergeProps, Fragment, resolveDirective, unref, provide, inject, reactive, Text, watchEffect, Transition, resolveDynamicComponent, TransitionGroup, vShow } from 'vue';
import { p as propsFactory, g as genericComponent, h as getCurrentInstance, x as templateRef, q as provideDefaults, j as convertToUnit, D as getCurrentInstanceName, m as makeThemeProps, l as provideTheme, f as getUid, t as useProxiedModel, E as deepEqual, y as destructComputed, w as includes, I as IconValue, H as useIcon, J as flattenFragments, o as useRtl, s as clamp, K as hasEvent, z as isCssColor, A as isParsableColor, B as parseColor, C as getForeground, F as wrapInArray, k as findChildrenWithProvide, G as consoleWarn, L as isObject, M as keyCodes } from './server.mjs';
...
export { LoaderSlot as $, VExpandXTransition as A, VIcon as B, VDefaultsProvider as C, makeTransitionProps as D, useBackgroundColor as E, useRouter as F, VBtn as G, useTextColor as H, VFadeTransition as I, parseAnchor as J, flipSide as K, flipAlign as L, MaybeTransition as M, flipCorner as N, getAxis as O, VExpandTransition as P, createSimpleFunctional as Q, Ripple as R, VImg as S, makeVBtnProps as T, makeLoaderProps as U, VContainer as V, makeLocationProps as W, makePositionProps as X, useLoader as Y, useLocation as Z, usePosition as _, makeTagProps as a, VSlideYTransition as a0, Intersect as a1, makeDimensionProps as b, useRender as c, VProgressCircular as d, makeDensityProps as e, makeGroupProps as f, useGroup as g, useResizeObserver as h, makeVariantProps as i, makeBorderProps as j, makeElevationProps as k, makeGroupItemProps as l, makeComponentProps as m, makeRoundedProps as n, makeRouterProps as o, makeSizeProps as p, useBorder as q, useVariant as r, useDensity as s, useElevation as t, useDimension as u, useRounded as v, useSize as w, useGroupItem as x, useLink as y, genOverlays as z };
//# sourceMappingURL=VContainer-lYWTOxzK.mjs.map
