...
import { V as VContainer, B as VIcon, G as VBtn } from './VContainer-lYWTOxzK.mjs';
import { V as VCard, a as VCardTitle, b as VTextField } from './VTextField-Byxaxvnz.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const signIn = async () => {
      ...
      (undefined).location.href = "/dashboard";
      if (!response.ok) {
...
//# sourceMappingURL=login-CYGbBCIY.mjs.map
