...
const styles = {
  ...
  "pages/login.vue": () => import('./login-styles.BEDS5BDu.mjs').then(interopDefault),
  ...
  "pages/login.vue?vue&type=style&index=0&lang.css": () => import('./login-styles.D_tH9o-0.mjs').then(interopDefault),
