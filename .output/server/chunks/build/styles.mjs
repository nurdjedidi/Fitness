...
const styles = {
  ...
  "pages/index.vue": () => import('./index-styles.Co56EzoM.mjs').then(interopDefault),
  "pages/login.vue": () => import('./login-styles.DHlQgLhr.mjs').then(interopDefault),
  "pages/signup.vue": () => import('./signup-styles.CLERSU2t.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=ad8ecac6&lang.css": () => import('./index-styles.DZ184MUl.mjs').then(interopDefault),
  "pages/login.vue?vue&type=style&index=0&lang.css": () => import('./login-styles.BGpwfwkc.mjs').then(interopDefault),
