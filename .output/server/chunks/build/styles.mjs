...
const styles = {
  ...
  "pages/dashboard.vue": () => import('./dashboard-styles.B44CVE1h.mjs').then(interopDefault),
  "pages/index.vue": () => import('./index-styles.B-Cy2m5j.mjs').then(interopDefault),
  ...
  "pages/dashboard.vue?vue&type=style&index=0&scoped=df8658bf&lang.css": () => import('./dashboard-styles.BoEyM40e.mjs').then(interopDefault),
