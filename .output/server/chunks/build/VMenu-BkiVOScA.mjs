import { createVNode, Transition, mergeProps, shallowRef, ref, toRef, computed, withDirectives, vShow, watch, Fragment, resolveDirective, reactive, Teleport, inject, provide, toRaw, watchEffect, nextTick, onScopeDispose, readonly } from 'vue';
import { m as makeComponentProps, h as makeTagProps, z as useRender, s as VDefaultsProvider, S as MaybeTransition, T as VExpandTransition, c as createSimpleFunctional, A as makeBorderProps, a as makeDensityProps, b as makeDimensionProps, d as makeElevationProps, g as makeRoundedProps, K as makeRouterProps, i as makeVariantProps, R as Ripple, O as useLink, B as useBorder, u as useVariant, j as useDensity, k as useDimension, l as useElevation, p as useRounded, r as genOverlays, V as VIcon, q as useTextColor, C as useBackgroundColor, Q as makeTransitionProps, D as useRouter, U as parseAnchor, W as flipSide, X as flipAlign, Y as flipCorner, Z as getAxis } from './VContainer-QB4JGugQ.mjs';
import { g as genericComponent, Q as defineComponent, p as propsFactory, I as IconValue, R as EventProp, m as makeThemeProps, f as provideTheme, S as deprecate, q as convertToUnit, v as provideDefaults, o as getCurrentInstance, e as useProxiedModel, t as useRtl, x as useToggleScope, U as omit, l as getUid, Y as isClickInsideElement, P as consoleError, G as deepEqual, V as focusChild, z as templateRef, Z as getNextElement, _ as focusableChildren, A as destructComputed, X as matchesSelector, H as wrapInArray, T as getPropertyFromItem, w as clamp, W as defer } from './server.mjs';
import { u as useSsrBoot } from './ssrBoot-BtvJZs44.mjs';
import { e as VAvatar, f as forwardRefs, g as animate, h as deceleratedEasing, s as standardEasing, i as acceleratedEasing, j as getTargetBox, n as nullifyTransforms, B as Box, k as getOverflow } from './VCard-Ba_RZk8v.mjs';
...
export { VDivider as V, VList as a, VListItem as b, VListItemTitle as c, VListItemSubtitle as d, VDialogTransition as e, VOverlay as f, makeDelayProps as g, useDelay as h, VMenu as i, makeItemsProps as j, useItems as k, makeVOverlayProps as m, useScopeId as u };
//# sourceMappingURL=VMenu-BkiVOScA.mjs.map
