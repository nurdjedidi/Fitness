import { capitalize, camelize, h, toRefs, computed, createVNode, isRef, toRef, shallowRef, ref, watch, nextTick, withDirectives, mergeProps, Fragment, resolveDirective, unref, Text, watchEffect, Transition, readonly, TransitionGroup, vShow, provide, inject, reactive, resolveDynamicComponent } from 'vue';
import { p as propsFactory, g as genericComponent, o as getCurrentInstance, v as provideDefaults, q as convertToUnit, F as getCurrentInstanceName, m as makeThemeProps, f as provideTheme, I as IconValue, K as useIcon, L as flattenFragments, t as useRtl, e as useProxiedModel, w as clamp, y as includes, z as templateRef, A as destructComputed, B as isCssColor, C as isParsableColor, D as parseColor, E as getForeground, l as getUid, G as deepEqual, M as hasEvent, H as wrapInArray, s as findChildrenWithProvide, J as consoleWarn, N as isObject, O as keyCodes } from './server.mjs';
        ...
        default: () => {
          ...
          return [genOverlays(true, "v-btn"), !props.icon && hasPrepend && createVNode("span", {
            ...
            default: () => {
              var _a3;
              var _a22;
              return [(_a3 = (_a22 = slots.default) == null ? undefined : _a22.call(slots)) != null ? _a3 : props.text];
            }
            ...
            "key": "loader",
            "class": "v-btn__loader"
          }, [(_a2 = (_a = slots.loader) == null ? undefined : _a.call(slots)) != null ? _a2 : createVNode(VProgressCircular, {
...
export { VSlideYTransition as $, makeBorderProps as A, useBorder as B, useBackgroundColor as C, useRouter as D, toPhysical as E, makeGroupProps as F, useGroup as G, useResizeObserver as H, VFadeTransition as I, makeGroupItemProps as J, makeRouterProps as K, makeSizeProps as L, useSize as M, useGroupItem as N, useLink as O, VExpandXTransition as P, makeTransitionProps as Q, Ripple as R, MaybeTransition as S, VExpandTransition as T, parseAnchor as U, VIcon as V, flipSide as W, flipAlign as X, flipCorner as Y, getAxis as Z, makeVBtnProps as _, makeDensityProps as a, makeLoaderProps as a0, useLoader as a1, LoaderSlot as a2, Intersect as a3, makeDimensionProps as b, createSimpleFunctional as c, makeElevationProps as d, makeLocationProps as e, makePositionProps as f, makeRoundedProps as g, makeTagProps as h, makeVariantProps as i, useDensity as j, useDimension as k, useElevation as l, makeComponentProps as m, useLocation as n, usePosition as o, useRounded as p, useTextColor as q, genOverlays as r, VDefaultsProvider as s, VBtn as t, useVariant as u, VContainer as v, VProgressCircular as w, VProgressLinear as x, VImg as y, useRender as z };
//# sourceMappingURL=VContainer-QB4JGugQ.mjs.map
