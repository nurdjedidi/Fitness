  ...
  _push(ssrRenderComponent(VApp, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(ssrRenderComponent(VBtn, {
                      color: "primary",
                      class: "login-btn d-sm-none d-md-flex",
                      variant: "outlined"
                    }, {
        ...
        _push2(`<section class="intro-img" data-v-1fb11738${_scopeId}><div class="overlay" data-v-1fb11738${_scopeId}></div>`);
        _push2(ssrRenderComponent(VContainer, { class: "intro-text" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<h1 data-v-1fb11738${_scopeId2}>Welcome to NutriWeb</h1><p data-v-1fb11738${_scopeId2}>Your health is our priority.</p>`);
              _push3(ssrRenderComponent(_component_NuxtLink, { to: "/login" }, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(ssrRenderComponent(VBtn, {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-1fb11738"]]);

export { index as default };
//# sourceMappingURL=index-BF9cUZu-.mjs.map
