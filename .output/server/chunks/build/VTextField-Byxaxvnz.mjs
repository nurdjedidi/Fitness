import { createVNode, Fragment, computed, withDirectives, mergeProps, resolveDirective, vShow, ref, toRef, watch, inject, cloneVNode, shallowRef, provide, markRaw, unref, nextTick } from 'vue';
import { m as makeComponentProps, c as useRender, a as makeTagProps, Q as createSimpleFunctional, j as makeBorderProps, e as makeDensityProps, n as makeRoundedProps, p as makeSizeProps, i as makeVariantProps, q as useBorder, r as useVariant, s as useDensity, v as useRounded, w as useSize, S as VImg, B as VIcon, C as VDefaultsProvider, z as genOverlays, b as makeDimensionProps, k as makeElevationProps, U as makeLoaderProps, W as makeLocationProps, X as makePositionProps, o as makeRouterProps, R as Ripple, u as useDimension, t as useElevation, Y as useLoader, Z as useLocation, _ as usePosition, y as useLink, $ as LoaderSlot, D as makeTransitionProps, a0 as VSlideYTransition, M as MaybeTransition, E as useBackgroundColor, H as useTextColor, A as VExpandXTransition, a1 as Intersect } from './VContainer-lYWTOxzK.mjs';
import { g as genericComponent, q as provideDefaults, p as propsFactory, I as IconValue, m as makeThemeProps, l as provideTheme, N as EventProp, o as useRtl, f as getUid, j as convertToUnit, F as wrapInArray, R as only, t as useProxiedModel, S as filterInputAttrs, O as useLocale, D as getCurrentInstanceName, P as isOn, Q as pick, G as consoleWarn, h as getCurrentInstance, v as useToggleScope, T as callEvent } from './server.mjs';
...
function useInputIcon(props) {
  ...
  function InputIcon(_ref) {
    ...
    const label = listener && localeKey ? t(`$vuetify.input.${localeKey}`, (_a = props.label) != null ? _a : "") : undefined;
...
function useForm(props) {
  ...
  return {
    ...
    isReadonly: computed(() => {
      var _a;
      return !!((_a = props == null ? undefined : props.readonly) != null ? _a : form == null ? undefined : form.isReadonly.value);
    }),
    isDisabled: computed(() => {
      var _a;
      return !!((_a = props == null ? undefined : props.disabled) != null ? _a : form == null ? undefined : form.isDisabled.value);
    })
  };
}
...
function useValidation(props) {
  ...
  const validateOn = computed(() => {
    var _a2, _b;
    var _a;
    let value = ((_a2 = props.validateOn) != null ? _a2 : (_a = form.validateOn) == null ? undefined : _a.value) || "input";
    if (value === "lazy") value = "input lazy";
    if (value === "eager") value = "input eager";
    const set = new Set((_b = value == null ? undefined : value.split(" ")) != null ? _b : []);
    return {
      input: set.has("input"),
  ...
  watch([isValid, errorMessages], () => {
    var _a;
    (_a = form.update) == null ? undefined : _a.call(form, uid.value, isValid.value, errorMessages.value);
  });
...
export { Box as B, VCard as V, VCardTitle as a, VTextField as b, VCardSubtitle as c, VAvatar as d, makeVTextFieldProps as e, forwardRefs as f, animate as g, getTargetBox as h, VLabel as i, VInput as j, deceleratedEasing as k, acceleratedEasing as l, makeVInputProps as m, nullifyTransforms as n, getOverflow as o, makeFormProps as p, createForm as q, standardEasing as s, useForm as u };
//# sourceMappingURL=VTextField-Byxaxvnz.mjs.map
