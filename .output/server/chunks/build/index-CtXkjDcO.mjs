...
import { c as createSimpleFunctional, b as VBtn, V as VContainer } from './VContainer-DobQ2tc6.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
  ...
  _push(ssrRenderComponent(VApp, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<section class="intro-img" data-v-366ef004${_scopeId}><div class="overlay" data-v-366ef004${_scopeId}></div>`);
        _push2(ssrRenderComponent(VContainer, { class: "intro-text" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<h1 data-v-366ef004${_scopeId2}>Welcome to NutriWeb</h1><p data-v-366ef004${_scopeId2}>Your health is our priority.</p>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-366ef004"]]);

export { index as default };
//# sourceMappingURL=index-CtXkjDcO.mjs.map
