import { computed, provide, onScopeDispose, toRef, createVNode, shallowRef, ref, mergeProps, withDirectives, Fragment, resolveDirective, inject, watch, createTextVNode, nextTick, watchEffect } from 'vue';
import { p as propsFactory, I as IconValue, B as deepEqual, m as makeThemeProps, g as genericComponent, A as useProxiedModel, z as getUid, j as provideDefaults, X as filterInputAttrs, Y as omit, f as useRtl, Z as isClickInsideElement, o as getCurrentInstance, V as useToggleScope, F as convertToUnit, S as useLocale, C as wrapInArray, a1 as ensureValidVNode, U as matchesSelector, _ as getNextElement, Q as focusableChildren, $ as focusChild, O as useDisplay, a0 as debounce, J as clamp, L as isObject, a2 as checkPrintable } from './server.mjs';
import { m as makeComponentProps, r as makeDensityProps, u as useRender, R as Ripple, b as VIcon, l as VDefaultsProvider, p as useResizeObserver, s as makeDimensionProps, z as useDimension, I as makeTransitionProps$1, J as VAvatar, y as useDensity, C as useTextColor, h as useBackgroundColor } from './index-DvYO7g7C.mjs';
import { a as VLabel, m as makeVInputProps, b as VInput, c as makeVTextFieldProps, u as useForm, V as VTextField } from './VTextField-Ga_rXM-Y.mjs';
import { f as forwardRefs } from './forwardRefs-Oip3fNRq.mjs';
import { m as makeItemsProps, e as useItems, V as VList, a as VListItem } from './VList-rSUx5yBU.mjs';
import { a as makeVOverlayProps, b as VDialogTransition, c as VMenuSymbol, d as VOverlay, V as VChip } from './VOverlay-Dd6qhf4Y.mjs';
...
export { VRadioGroup as V, VRadio as a, VSelect as b, VCheckboxBtn as c };
//# sourceMappingURL=VSelect-DBwJRfb7.mjs.map
