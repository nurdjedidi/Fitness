import { createVNode, Transition, mergeProps, reactive, ref, computed, toRef, watch, Fragment, Teleport, withDirectives, vShow, resolveDirective, inject, watchEffect, nextTick, onScopeDispose, shallowRef, provide, toRaw, readonly } from 'vue';
import { g as animate, h as getTargetBox, n as nullifyTransforms, i as deceleratedEasing, s as standardEasing, j as acceleratedEasing, B as Box, k as getOverflow } from './VCard-DbQ6I4oC.mjs';
import { k as genericComponent, p as propsFactory, f as getCurrentInstance, m as makeThemeProps, B as useProxiedModel, l as provideTheme, o as useRtl, Q as useToggleScope, h as convertToUnit, t as templateRef, v as destructComputed, P as matchesSelector, N as consoleError, H as clamp, O as defer } from './server.mjs';
import { m as makeComponentProps, f as makeDimensionProps, L as makeTransitionProps, M as useBackgroundColor, o as useDimension, T as useRouter, z as useRender, N as MaybeTransition, X as parseAnchor, Y as flipSide, Z as flipAlign, _ as flipCorner, $ as getAxis } from './VContainer-DobQ2tc6.mjs';
...
export { VDialogTransition as V, useDelay as a, makeVOverlayProps as b, VOverlay as c, VMenuSymbol as d, makeDelayProps as m, useScopeId as u };
//# sourceMappingURL=VOverlay-DwrbUdR6.mjs.map
