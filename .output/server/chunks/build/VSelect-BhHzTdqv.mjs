import { computed, provide, onScopeDispose, toRef, createVNode, shallowRef, ref, mergeProps, withDirectives, Fragment, resolveDirective, vShow, watch, createTextVNode, inject, nextTick, watchEffect } from 'vue';
import { p as propsFactory, I as IconValue, C as deepEqual, m as makeThemeProps, k as genericComponent, B as useProxiedModel, g as getUid, s as provideDefaults, X as filterInputAttrs, V as omit, Y as makeDisplayProps, o as useRtl, Z as useDisplay, _ as useGoTo, l as provideTheme, S as EventProp, a0 as useLocale, f as getCurrentInstance, Q as useToggleScope, h as convertToUnit, D as wrapInArray, a2 as ensureValidVNode, P as matchesSelector, $ as focusableChildren, a1 as debounce, H as clamp, K as isObject, a3 as checkPrintable } from './server.mjs';
import { m as makeComponentProps, e as makeDensityProps, z as useRender, R as Ripple, d as VIcon, k as makeTagProps, A as makeGroupProps, B as useGroup, C as useResizeObserver, l as makeVariantProps, D as makeBorderProps, g as makeElevationProps, E as makeGroupItemProps, j as makeRoundedProps, F as makeRouterProps, G as makeSizeProps, H as useBorder, u as useVariant, n as useDensity, p as useElevation, s as useRounded, I as useSize, J as useGroupItem, K as useLink, v as genOverlays, w as VDefaultsProvider, f as makeDimensionProps, o as useDimension, L as makeTransitionProps, t as useTextColor, M as useBackgroundColor } from './VContainer-DobQ2tc6.mjs';
import { a as VLabel, m as makeVInputProps, b as VInput, c as makeVTextFieldProps, u as useForm, V as VTextField } from './VTextField-CnDddFIy.mjs';
import { e as VAvatar, f as forwardRefs } from './VCard-DbQ6I4oC.mjs';
import { m as makeItemsProps, u as useItems, a as VList, b as VListItem } from './VList-CH1gHPfw.mjs';
import { V as VDialogTransition } from './VOverlay-DwrbUdR6.mjs';
import { V as VMenu } from './VMenu-CyOENCQL.mjs';
import { V as VFadeTransition, a as VExpandXTransition } from './index-BPirZAZN.mjs';
...
export { VRadioGroup as V, VRadio as a, VSelect as b };
//# sourceMappingURL=VSelect-BhHzTdqv.mjs.map
