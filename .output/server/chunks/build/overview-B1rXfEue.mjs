...
import { p as propsFactory, I as IconValue, m as makeThemeProps, k as genericComponent, B as useProxiedModel, l as provideTheme, a0 as useLocale, e as useUserStore } from './server.mjs';
import { useRouter } from 'vue-router';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { V as VApp } from './VApp-Cei7yiz0.mjs';
import { V as VMain } from './VMain-C8ySkDSL.mjs';
import { c as createSimpleFunctional, m as makeComponentProps, e as makeDensityProps, f as makeDimensionProps, g as makeElevationProps, h as makeLocationProps, i as makePositionProps, j as makeRoundedProps, k as makeTagProps, l as makeVariantProps, u as useVariant, n as useDensity, o as useDimension, p as useElevation, q as useLocation, r as usePosition, s as useRounded, t as useTextColor, v as genOverlays, d as VIcon, w as VDefaultsProvider, b as VBtn, V as VContainer, x as VProgressCircular, y as VProgressLinear } from './VContainer-DobQ2tc6.mjs';
import { V as VDialog } from './VDialog-ZdGrCytX.mjs';
import { V as VCard, a as VCardTitle, c as VCardText, d as VCardActions, b as VCardSubtitle } from './VCard-DbQ6I4oC.mjs';
import { V as VDivider, a as VList, b as VListItem, c as VListItemTitle, d as VListItemSubtitle } from './VList-CH1gHPfw.mjs';
import { V as VRow, a as VCol } from './VRow-CqISRmPd.mjs';
import { V as VTextField } from './VTextField-CnDddFIy.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
                                    ...
                                    _push6(ssrRenderComponent(VCardTitle, { class: "d-flex align-center" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          _push7(`<span class="text-h5 font-weight-bold ml-2" data-v-6418500b${_scopeId6}>Warning</span>`);
                                        } else {
                                          return [
                                            createVNode(VIcon, {
                                              color: "orange",
                                                    ...
                                                    if (_push9) {
                                                      _push9(ssrRenderComponent(VProgressCircular, {
                                                        ...
                                                        default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                          if (_push10) {
                                                            _push10(`<span class="font-weight-bold text-center" data-v-6418500b${_scopeId9}>${ssrInterpolate(Math.round(unref(userStore).recipes.totalCalories))} / ${ssrInterpolate(Math.round(unref(userStore).form.calories))} kcal </span>`);
                                                          } else {
                                                            return [
                                                              ...
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  ...
                                                                  _push11(ssrRenderComponent(VListItemTitle, null, {
                                                                    default: withCtx((_11, _push12, _parent12, _scopeId11) => {
                                                                      if (_push12) {
                                                                        _push12(`Carbs: <strong data-v-6418500b${_scopeId11}>${ssrInterpolate(Math.round(unref(userStore).recipes.totalCarbs))} / ${ssrInterpolate(Math.round(unref(userStore).goals.target_carbs))} g</strong>`);
                                                                      } else {
                                                                        return [
                                                              ...
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  ...
                                                                  _push11(ssrRenderComponent(VListItemTitle, null, {
                                                                    default: withCtx((_11, _push12, _parent12, _scopeId11) => {
                                                                      if (_push12) {
                                                                        _push12(`Proteins: <strong data-v-6418500b${_scopeId11}>${ssrInterpolate(Math.round(unref(userStore).recipes.totalLipids))} / ${ssrInterpolate(Math.round(unref(userStore).goals.target_lipids))} g</strong>`);
                                                                      } else {
                                                                        return [
                                                              ...
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  ...
                                                                  _push11(ssrRenderComponent(VListItemTitle, null, {
                                                                    default: withCtx((_11, _push12, _parent12, _scopeId11) => {
                                                                      if (_push12) {
                                                                        _push12(`Fats: <strong data-v-6418500b${_scopeId11}>${ssrInterpolate(Math.round(unref(userStore).recipes.totalProteins))} / ${ssrInterpolate(Math.round(unref(userStore).goals.target_proteins))} g</strong>`);
                                                                      } else {
                                                                        return [
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                ...
                                                ssrRenderList(unref(progressMacros), (macro, macroIndex) => {
                                                  _push8(`<div class="d-flex flex-column align-center" data-v-6418500b${_scopeId7}><span class="text-center font-weight-bold" data-v-6418500b${_scopeId7}>${ssrInterpolate(macro.title)}</span>`);
                                                    ...
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        _push9(ssrRenderComponent(VListItemTitle, null, {
                                                          default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                            if (_push10) {
                                                              _push10(`<strong data-v-6418500b${_scopeId9}>${ssrInterpolate(Math.round(macrosGoal.value))}g of ${ssrInterpolate(macrosGoal.texte)}</strong>`);
                                                            } else {
                                                              return [
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(VCardTitle, { class: "d-flex align-center justify-center" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                ...
                                                _push8(`<span class="text-h5 font-weight-bold" data-v-6418500b${_scopeId7}>Dashboard Consumptions</span>`);
                                              } else {
                                                return [
                                                  createVNode(VIcon, {
                                                    class: "mr-2",
                                          ...
                                          _push7(ssrRenderComponent(VCardText, null, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div class="d-flex align-center" data-v-6418500b${_scopeId7}>`);
                                                      ...
                                                      _push9(ssrRenderComponent(VCol, null, {
                                                        default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                          if (_push10) {
                                                            ...
                                                            _push10(`<span class="ml-2" data-v-6418500b${_scopeId9}>Today you have consumed</span>`);
                                                          } else {
                                                            return [
                                                ...
                                                _push8(`</div><div class="mt-2" data-v-6418500b${_scopeId7}>`);
                                                _push8(ssrRenderComponent(VProgressLinear, {
                                                  ...
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(`<strong data-v-6418500b${_scopeId8}>${ssrInterpolate(Math.round(unref(userStore).recipes.totalCalories))} / ${ssrInterpolate(Math.round(unref(userStore).form.calories))} kcal</strong>`);
                                                    } else {
                                                      return [
                                                ...
                                                _push8(`<div class="d-flex justify-space-between" data-v-6418500b${_scopeId7}><span data-v-6418500b${_scopeId7}>Consumed</span><span data-v-6418500b${_scopeId7}>Goal</span></div></div>`);
                                              } else {
                                                return [
...
const overview = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6418500b"]]);

export { overview as default };
//# sourceMappingURL=overview-B1rXfEue.mjs.map
